...
import com.example.xiaotianweather.base.CHImageView;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        grid_item_delete.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                View deleteview = LayoutInflater.from(context).inflate(R.layout.exitapp_dialog,
                        null);
                ...
                leftbutton.setOnClickListener(new OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        int index = db.delete("guanoweather", "cityname = ?", new String[] {
                                mcityname
                        });
                        if (index == 0) {
